...
const serviceData = {
  ...
  biochemistry: {
    kft: {
      ...
      points:
        "Detect Kidney Disease-Monitor Renal Function-Assess Hydration",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats, Livestock",
    },
    lft: {
      ...
      points:
        "Detect Liver Damage-Monitor Enzymes-Assess Metabolism",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats, Livestock",
    },
    ast: {
      ...
      points:
        "Evaluate Liver Enzymes-Check Protein Levels-Detect Jaundice",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats, Livestock",
    },
    urea: {
      ...
      points:
        "Assess Kidney Health-Detect Toxin Build-up-Monitor Metabolism",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats, Livestock",
    },
    t3: {
      ...
      points:
        "Assess Thyroid Function-Detect Hormonal Imbalance",
      sampletype: "Blood",
    ...
    tsh: {
      ...
      points:
        "Evaluate Thyroid-Stimulating Hormone-Detect Hypothyroidism",
      sampletype: "Blood",
      Resulttime: "24-48 hrs",
      Applicablefor: "Dogs",
    },
    t4: {
      title: "Canine Specific T4",
      image: img,
      description:
        "T4 test measures thyroxine hormone levels to assess thyroid health in dogs.",
      points:
        "Detect Thyroid Disorders-Monitor Hormone Levels",
      sampletype: "Blood",
      Resulttime: "24-48 hrs",
      Applicablefor: "Dogs",
    },
    ldh: {
      ...
      points:
        "Detect Tissue Damage-Monitor Disease Progression",
      sampletype: "Blood",
      Resulttime: "24 hrs",
    ...
    rbs: {
      ...
      points:
        "Detect Diabetes-Monitor Glucose Levels",
      sampletype: "Blood",
      Resulttime: "Same Day",
      Applicablefor: "Dogs, Cats",
    },
    sl: {
      ...
      points:
        "Detect Pancreatitis-Assess Digestive Health",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats",
    },
    sa: {
      ...
      points:
        "Check Organ Function-Assess Metabolism",
      sampletype: "Blood",
      Resulttime: "24 hrs",
      Applicablefor: "Dogs, Cats, Livestock",
    },
    b12: {
      ...
      points:
        "Detect Deficiency-Support Nerve Health",
      sampletype: "Blood",
      Resulttime: "24-48 hrs",
      Applicablefor: "Dogs, Cats",
    },
    d: {
      ...
      points:
        "Assess Bone Health-Detect Deficiency",
      sampletype: "Blood",
      Resulttime: "24-48 hrs",
      Applicablefor: "Dogs, Cats",
    },
  ...
  MolecularBiology: {
    ...
    ctfc: {
      2: {
        ...
        points:
          "Detect Tick Fever-Early Diagnosis",
        sampletype: "Blood",
        Resulttime: "24-48 hrs",
        Applicablefor: "Dogs",
      },
      ...
      ctfpbv: {
        ...
        image: img,
        description:
          "Detects Babesia vogeli infection transmitted by ticks.",
        points:
          "Tick Disease Detection",
        sampletype: "Blood",
        Resulttime: "24-48 hrs",
        Applicablefor: "Dogs",
      },
      ...
      ctfpap: {
        ...
        image: img,
        description:
          "Detects Anaplasma platys infection affecting platelets.",
        points:
          "Detect Platelet Disorder",
        sampletype: "Blood",
        Resulttime: "24-48 hrs",
        Applicablefor: "Dogs",
      },
  ...
  Histopathology: {
    biopsy: {
      ...
      points:
        "Detect Cancer-Identify Tissue Damage",
      sampletype: "Tissue",
      Resulttime: "3-5 days",
      Applicablefor: "Dogs, Cats",
    },
    ...
    sse: {
      ...
      image: img,
      description:
        "Detects mites, fungal infections, and skin parasites.",
      points:
  ...
  plt: {
    ...
    image: img,
    description:
      "Detects pancreatic inflammation and pancreatitis in animals.",
    points:
